    ...
    <div class="flex flex-col bg-white px-8 py-2 rounded-xl">
        <div class="flex flex-row items-center">
            <svg class=" w-12" viewBox="0 0 24 24">
                <path class=" fill-current text-red-500" d="M13 14h-2V9h2m0 9h-2v-2h2M1 21h22L12 2 1 21z" /></svg>
        ...
        <div class="flex flex-row justify-end mt-3">
            <button @click="this.$store.state.show_emp_supp=false" class=" bg-indigo-500 px-3 rounded-lg text-white">Non</button>
